...
[baseImage,insertionCommand,PVs] = parseInputs(varargin{:});
...
opt = [ '-r' num2str(dpi) ];
imgOut = print(thisFig,'-RGBImage', opt);
%imgOut = print(thisFig,'-RGBImage','-r150');
delete(thisFig);
...
% BEGIN NESTED SUBFUNCTIONS
	...
	function [baseImage,insertionCommand,PVs] = parseInputs(varargin)
		narginchk(2,3);
